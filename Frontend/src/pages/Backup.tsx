...
export default function Backup() {
  ...
  return (
    <RootDiv style={{}}>
      <div className="w-full max-w-[1400px] py-10 space-y-10">
        <div className="flex items-center justify-between pb-6 border-b border-white/5">
          ...
          <div className="flex gap-3">
            ...
            <Button
              variant="ghost"
              className="gap-2 px-4 py-2 rounded-xl text-xs font-bold tracking-wider uppercase transition-all border border-rose-500/30 text-rose-400 bg-rose-500/10 hover:bg-rose-500/20 hover:text-rose-300 shadow-[0_0_15px_rgba(244,63,94,0.1)]"
            ...
            <Button
              variant="ghost"
              className="gap-2 px-4 py-2 rounded-xl text-xs font-bold tracking-wider uppercase transition-all border border-cyan-500/40 text-cyan-400 bg-cyan-500/20 hover:bg-cyan-500/30 hover:text-cyan-300 shadow-[0_0_15px_rgba(34,211,238,0.2)]"
        ...
        <div className="space-y-4">
          <h2 className="text-[10px] font-bold text-white/30 uppercase tracking-widest pl-1">
            Danh sách phao cứu sinh
          </h2>

          {loading ? (
            <div className="text-center py-16 border-2 border-dashed border-white/5 rounded-2xl bg-[#09090b]/40 backdrop-blur-sm">
              <p className="text-white/40 uppercase tracking-wider text-sm font-bold animate-pulse">
                Đang tìm phao...
              </p>
            </div>
          ) : (
            <div className="grid gap-3">
              {restorePoints.map((rp) => (
                ...
                >
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      <h3 className="font-bold tracking-wider text-sm text-white/90 group-hover:text-white transition-colors">
                        {rp.Description || `Restore Point #${rp.SequenceNumber}`}
                      </h3>
              ...
              {restorePoints.length === 0 && (
                <div className="text-center py-16 border-2 border-dashed border-rose-500/20 rounded-2xl bg-rose-950/10 backdrop-blur-sm">
                  <p className="text-rose-400/60 uppercase tracking-wider text-sm font-bold">
                    Chưa có cái phao nào, liều quá vậy!
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="p-8 rounded-3xl border border-cyan-500/20 bg-[#0a0a0c]/95 backdrop-blur-2xl shadow-[0_0_50px_rgba(34,211,238,0.15)] space-y-6">
            <div className="flex items-center gap-4 pb-4 border-b border-white/5">
              ...
              <div>
                ...
                <p className="text-xs text-cyan-400/60 uppercase tracking-widest font-bold mt-1">
                  Hệ Thống Phục Hồi
                </p>
              </div>
            </div>
            ...
            <p className="text-sm text-white/60 leading-relaxed font-medium">
              Bấm phát lưu luôn tình trạng máy tính hiện tại. Nếu sau này vọc vạch lỗi thì lôi ra
              backup, tỷ lệ về bờ 100%.
            </p>
            ...
            <div className="pt-4 flex justify-end gap-3">
              ...
              <Button
                variant="ghost"
                className="px-5 py-2.5 rounded-xl uppercase text-xs font-bold border border-cyan-500/40 text-cyan-400 bg-cyan-500/20 hover:bg-cyan-500/30 hover:text-cyan-300 transition-all shadow-[0_0_15px_rgba(34,211,238,0.2)]"
        ...
        <Modal
          open={deleteOpen}
          onClose={() => !deleting && (setDeleteOpen(false), setDeletingId(null))}
        >
          <div className="p-8 rounded-3xl border border-rose-500/20 bg-[#0a0a0c]/95 backdrop-blur-2xl shadow-[0_0_50px_rgba(244,63,94,0.15)] space-y-6">
            <div className="flex items-center gap-4 pb-4 border-b border-white/5">
              ...
              <div>
                ...
                <p className="text-xs text-rose-400/60 uppercase tracking-widest font-bold mt-1">
                  Cảnh Báo Nguy Hiểm
                </p>
              </div>
            </div>
            ...
            <div className="pt-4 flex justify-end gap-3">
              ...
              <Button
                ...
                onClick={() =>
                  deletingId !== null
                    ? handleDeleteSingleBackup(deletingId)
