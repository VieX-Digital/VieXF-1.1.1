...
const translations = {
  ...
  "debloat-windows": {
    ...
    desc: {
      en: "Removes built-in bloatware apps.",
      vi: "Gỡ bỏ các ứng dụng cài sẵn không cần thiết.",
    },
  },
  "detailed-bsod": {
  ...
  "optimize-nvidia-settings": {
    ...
    desc: {
      en: "Applies optimized profile for NVIDIA GPUs.",
      vi: "Áp dụng profile tối ưu cho card màn hình NVIDIA.",
    },
  },
  "remove-gaming-apps": {
  ...
  "vie-amx": {
    ...
    desc: {
      en: "Applies Vie's custom Advanced Matrix optimizations.",
      vi: "Áp dụng các tối ưu hóa Advanced Matrix của Vie.",
    },
  },
}
  ...
  for (const dir of files) {
    ...
    try {
      ...
      if (meta.deepDescription) {
        ...
        const deepVi =
          typeof meta.deepDescription === "object" ? meta.deepDescription.vi : meta.deepDescription
